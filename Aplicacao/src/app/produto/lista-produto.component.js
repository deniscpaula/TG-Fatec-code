...
var ListaProdutoComponent = (function () {
    function ListaProdutoComponent(service, loginService) {
        var _this = this;
        ...
        service.listar(null).subscribe(function (produtos) { return _this.produtos = produtos; });
    }
...
ListaProdutoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [produto_service_1.ProdutoService, login_service_1.LoginService])
