...
var AlertaComponent = (function () {
    ...
    AlertaComponent.prototype.ngOnChanges = function () {
        var _this = this;
        setTimeout(function () {
            _this.alerta.mensagem = '';
        }, 7000);
    };
...
__decorate([
    core_1.Input(),
    __metadata("design:type", alerta_1.Alerta)
], AlertaComponent.prototype, "alerta", void 0);
...
exports.AlertaComponent = AlertaComponent;
