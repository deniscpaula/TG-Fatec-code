...
var ColaboradorService = (function () {
    function ColaboradorService(webservice) {
        this.webservice = webservice;
    }
    ColaboradorService.prototype.salvar = function (colaborador) {
    ...
    ColaboradorService.prototype.listar = function (status) {
        var colaborador = JSON.parse(sessionStorage.getItem('colaborador'));
        var path = 'colaborador/list/' + colaborador.empresa.codigo + '/';
        if (status == null)
    ...
    ColaboradorService.prototype.buscar = function (codigo) {
